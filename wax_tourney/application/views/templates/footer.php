...
<!--	<a href="--><?//=site_url()?><!--" class="nav-icon current"><i class="fas fa-table"></i></a>-->
	...
	<a id="champ" href="<?=site_url()?>/waxtourney/champ?week=14" class="nav-icon"><i class="fas fa-trophy"></i></a>
	<a id="consolation" href="<?=site_url()?>/waxtourney/consolation?week=15" class="nav-icon"><i class="fas fa-award"></i></a>
	<a id="feces" href="<?=site_url()?>/waxtourney/feces?week=14" class="nav-icon"><i class="fas fa-poop"></i></a>
</nav>
